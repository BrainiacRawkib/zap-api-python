...
def main():
    parser = argparse.ArgumentParser(
        prog="ZAP Zed Attack Proxy Script",
        description="ZAP (Zed Attack Proxy) execution script.")
    # positional argument
    ...
    parser.add_argument("--zap_sock",
                        ...
                        type=str)
    parser.add_argument("--useProxyChain",
                        help="Define if an outgoing proxy server is used",
                        type=bool, default=False)
    parser.add_argument("--proxyAddress",
                        help="only if useProxyChain is True, ignored otherwise.",
                        type=str)
    parser.add_argument("--proxyPort",
                        help="only if useProxyChain is True, ignored otherwise.",
                        type=str)
    parser.add_argument("--skipProxyAddresses",
                        help="only if useProxyChain is True, ignored otherwise.",
                        type=str,
                        metavar="List of addresses seperated by comma, e.g \"8.8.8.8,1.1.1.1\"")
    ...
    skip_proxy_addresses = args.skipProxyAddresses
    ...
    if zap_socket:
        localProxy = {"http": zap_socket, "https": zap_socket}
    else:
    ...
    if use_proxyChain:
        ...
        skipProxyAddresses = skip_proxy_addresses.split(',')
    else:
        useProxyChain = False
